...
const getCurrencyIcon = (currency: string): JSX.Element => {
  ...
  switch (currency) {
    ...
    case 'KES':
      avatar = (
        <Avatar className="text-muted-foreground w-8 h-8">
    ...
    case 'GHS':
      avatar = (
        <Avatar className="text-muted-foreground">
          <AvatarImage src="/gh.png" alt="Nigerian Naira" />
        </Avatar>
      );
      break;
    default:
      avatar = (
        <Avatar className="text-muted-foreground">
          <AvatarImage src="/gh.png" alt="Ghanian Cedi" />
        </Avatar>
      );
  }
  return avatar;
...
export interface SpliceAmountInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  currency: string;
}
...
export interface SpliceAddressInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  isValid?: boolean;
}
