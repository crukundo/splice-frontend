        ...
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
          <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
            <h1 className="font-heading text-2xl sm:text-4xl md:text-5xl lg:text-6xl">
              Seamless &amp; Affordable <br />
              Cross-Border Remittances
            </h1>
            <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-lg sm:leading-8">
              {isMobile
                ? `Splice is on a mission to simplify cross-border money movement in Africa with a cost-effective solution that outshines traditional banks and neobanks.`
                    ...
                    <form>
                      ...
                      <div className="grid py-4">
                        <Button
                          ...
                          disabled={isLoading || !enteredWalletId}
                          type="submit"
                        >
